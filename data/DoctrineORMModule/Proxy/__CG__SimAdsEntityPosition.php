...
namespace DoctrineORMModule\Proxy\__CG__\SimAds\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Position extends \SimAds\Entity\Position implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'active', 'registeredBy', 'registeredIn', 'modifiedBy', 'modifiedIn');
        }
