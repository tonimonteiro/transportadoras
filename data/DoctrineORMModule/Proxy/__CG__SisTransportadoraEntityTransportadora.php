...
namespace DoctrineORMModule\Proxy\__CG__\SisTransportadora\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Transportadora extends \SisTransportadora\Entity\Transportadora implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Transportadora $proxy) {
