 ...
 *
 * This file is included first, before each other
 *
 * @package KCFinder
 * @version 3.10
...
require $documentRoot . '/vendor/zendframework/zendframework/library/Zend/Loader/StandardAutoloader.php';
$loader = new Zend\Loader\StandardAutoloader(array('autoregister_zf' => true));
$loader->register();

include $documentRoot . 'init_autoloader.php';
include $documentRoot . 'config/autoload/global.php';

$sessionName    = $params['session']['administrator'];
...
$sessionStorage = new Zend\Authentication\Storage\Session($sessionName);
$authService = new Zend\Authentication\AuthenticationService();
$authService->setStorage($sessionStorage);

if (! empty($authService->hasIdentity())) {
    $session = new Zend\Session\Container('SessionAdminAdditional');
    $_SESSION['kcfinder'] = $session->kcfinder;
} else {
    session_unset();
    session_destroy();
    unset($_SESSION);
